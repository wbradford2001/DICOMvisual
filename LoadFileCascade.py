...
def load_file(master):
        ...
        master.loading_window = TopLevelWindow.top_window(master, 600, 400, title = "Loading Files", color = 'grey')
        master.loading_bar = LoadingBar.loading_bar(parent = master.loading_window, 
...
def populate_data_stuff(master):
    ...
    # try:
        ...
        if len(master.dfs) == 1:
            ...
            MainView = PixelDisplay.pixel_display(master = master, root = master.MainViewCanvas, title= "Main View", arr=MainView_arr, aspect=MainView_aspect,main_or_side = "main")
            ...
            SideView1 = PixelDisplay.pixel_display(master = master, root = master.SideView1Canvas, title= "Side View 1", arr=SideView1_arr, aspect=SideView1_aspect,  main_or_side = "side")


            SideView2 = PixelDisplay.pixel_display(master = master, root = master.SideView2Canvas, title= "Side View 2", arr=SideView2_arr, aspect=SideView2_aspect,main_or_side = "side")
