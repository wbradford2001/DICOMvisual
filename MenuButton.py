...
class menu_button:
    ...
    menubuttonheight = 30
    canvasheight = 50
    def __init__(self, master, root, xpos, width, title):
        self.master = master
        self.canvobj = tk.Canvas(root, bg  = menu_button.canvas_color, bd = 0, highlightthickness=0, relief = 'ridge')
        self.canvobj.place(x = 0, y = menu_button.menubuttonheight, width = self.master.width, height = menu_button.canvasheight)
